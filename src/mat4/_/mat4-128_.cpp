...
#define MUL(dst, left, right)\
	\
	alignas(16) const __m128 l1 = left[3];\
	alignas(16) const __m128 l2 = left[2];\
	alignas(16) const __m128 l3 = left[1];\
	alignas(16) const __m128 l4 = left[0];\
	\
	alignas(16) const __m128 r1 = right[3];\
	alignas(16) const __m128 r2 = right[2];\
	alignas(16) const __m128 r3 = right[1];\
	alignas(16) const __m128 r4 = right[0];\
	\
	alignas(16) const __m128 aa1 = _mm_mul_ps(l1, _mm_shuffle_ps(r1, r1, _MM_SHUFFLE(3, 3, 3, 3)));\
	alignas(16) const __m128 bb1 = _mm_mul_ps(l1, _mm_shuffle_ps(r2, r2, _MM_SHUFFLE(3, 3, 3, 3)));\
	alignas(16) const __m128 cc1 = _mm_mul_ps(l1, _mm_shuffle_ps(r3, r3, _MM_SHUFFLE(3, 3, 3, 3)));\
	alignas(16) const __m128 dd1 = _mm_mul_ps(l1, _mm_shuffle_ps(r4, r4, _MM_SHUFFLE(3, 3, 3, 3)));\
	\
	alignas(16) const __m128 aa2 = _mm_add_ps(aa1, _mm_mul_ps(l2, _mm_shuffle_ps(r1, r1, _MM_SHUFFLE(2, 2, 2, 2))));\
	alignas(16) const __m128 bb2 = _mm_add_ps(bb1, _mm_mul_ps(l2, _mm_shuffle_ps(r2, r2, _MM_SHUFFLE(2, 2, 2, 2))));\
	alignas(16) const __m128 cc2 = _mm_add_ps(cc1, _mm_mul_ps(l2, _mm_shuffle_ps(r3, r3, _MM_SHUFFLE(2, 2, 2, 2))));\
	alignas(16) const __m128 dd2 = _mm_add_ps(dd1, _mm_mul_ps(l2, _mm_shuffle_ps(r4, r4, _MM_SHUFFLE(2, 2, 2, 2))));\
	\
	alignas(16) const __m128 aa3 = _mm_add_ps(aa2, _mm_mul_ps(l3, _mm_shuffle_ps(r1, r1, _MM_SHUFFLE(1, 1, 1, 1))));\
	alignas(16) const __m128 bb3 = _mm_add_ps(bb2, _mm_mul_ps(l3, _mm_shuffle_ps(r2, r2, _MM_SHUFFLE(1, 1, 1, 1))));\
	alignas(16) const __m128 cc3 = _mm_add_ps(cc2, _mm_mul_ps(l3, _mm_shuffle_ps(r3, r3, _MM_SHUFFLE(1, 1, 1, 1))));\
	alignas(16) const __m128 dd3 = _mm_add_ps(dd2, _mm_mul_ps(l3, _mm_shuffle_ps(r4, r4, _MM_SHUFFLE(1, 1, 1, 1))));\
	\
	dst[3] = _mm_add_ps(aa3, _mm_mul_ps(l4, _mm_shuffle_ps(r1, r1, _MM_SHUFFLE(0, 0, 0, 0))));\
	dst[2] = _mm_add_ps(bb3, _mm_mul_ps(l4, _mm_shuffle_ps(r2, r2, _MM_SHUFFLE(0, 0, 0, 0))));\
	dst[1] = _mm_add_ps(cc3, _mm_mul_ps(l4, _mm_shuffle_ps(r3, r3, _MM_SHUFFLE(0, 0, 0, 0))));\
	dst[0] = _mm_add_ps(dd3, _mm_mul_ps(l4, _mm_shuffle_ps(r4, r4, _MM_SHUFFLE(0, 0, 0, 0))));

// #define MUL2(dst128, L32, R32)\
// 	\
// 	alignas(16) __m128 a = _mm_shuffle_ps(L128[0], L128[1], _MM_SHUFFLE(1, 0, 1, 0));\
// 	alignas(16) __m128 b = _mm_shuffle_ps(L128[2], L128[3], _MM_SHUFFLE(1, 0, 1, 0));\
// 	alignas(16) const __m128 l1 = _mm_shuffle_ps(a, b, _MM_SHUFFLE(2, 0, 2, 0));\
// 	alignas(16) const __m128 l2 = _mm_shuffle_ps(a, b, _MM_SHUFFLE(3, 1, 3, 1));\
// 	\
// 	a = _mm_shuffle_ps(L128[0], L128[1], _MM_SHUFFLE(3, 2, 3, 2));\
// 	b = _mm_shuffle_ps(L128[2], L128[3], _MM_SHUFFLE(3, 2, 3, 2));\
// 	alignas(16) const __m128 l3 = _mm_shuffle_ps(a, b, _MM_SHUFFLE(2, 0, 2, 0));\
// 	alignas(16) const __m128 l4 = _mm_shuffle_ps(a, b, _MM_SHUFFLE(3, 1, 3, 1));\
// 	\
// 	alignas(16) __m128 m1 = _mm_mul_ps(l1, R128[0]);\
// 	alignas(16) __m128 m2 = _mm_mul_ps(l2, R128[0]);\
// 	alignas(16) __m128 m3 = _mm_mul_ps(l3, R128[0]);\
// 	alignas(16) __m128 m4 = _mm_mul_ps(l4, R128[0]);\
// 	alignas(16) __m128 m5 = _mm_mul_ps(l1, R128[1]);\
// 	alignas(16) __m128 m6 = _mm_mul_ps(l2, R128[1]);\
// 	alignas(16) __m128 m7 = _mm_mul_ps(l3, R128[1]);\
// 	alignas(16) __m128 m8 = _mm_mul_ps(l4, R128[1]);\
// 	alignas(16) __m128 m9 = _mm_mul_ps(l1, R128[2]);\
// 	alignas(16) __m128 m10 = _mm_mul_ps(l2, R128[2]);\
// 	alignas(16) __m128 m11 = _mm_mul_ps(l3, R128[2]);\
// 	alignas(16) __m128 m12 = _mm_mul_ps(l4, R128[2]);\
// 	alignas(16) __m128 m13 = _mm_mul_ps(l1, R128[3]);\
// 	alignas(16) __m128 m14 = _mm_mul_ps(l2, R128[3]);\
// 	alignas(16) __m128 m15 = _mm_mul_ps(l3, R128[3]);\
// 	alignas(16) __m128 m16 = _mm_mul_ps(l4, R128[3]);\
// 	\

// 	\
// 	alignas(16) const __m128 a = _mm_load_ps(L32);\
// 	alignas(16) const __m128 b = _mm_load_ps(&L32[4]);\
// 	alignas(16) const __m128 c = _mm_load_ps(&L32[8]);\
// 	alignas(16) const __m128 d = _mm_load_ps(&L32[12]);\
// 	\
// 	dst128[0] = _mm_mul_ps(a, _mm_set1_ps(R32[0]));\
// 	dst128[1] = _mm_mul_ps(a, _mm_set1_ps(R32[4]));\
// 	dst128[2] = _mm_mul_ps(a, _mm_set1_ps(R32[8]));\
// 	dst128[3] = _mm_mul_ps(a, _mm_set1_ps(R32[12]));\
// 	\
// 	dst128[0] = _mm_add_ps(dst128[0], _mm_mul_ps(b, _mm_set1_ps(R32[1])));\
// 	dst128[1] = _mm_add_ps(dst128[1], _mm_mul_ps(b, _mm_set1_ps(R32[5])));\
// 	dst128[2] = _mm_add_ps(dst128[2], _mm_mul_ps(b, _mm_set1_ps(R32[9])));\
// 	dst128[3] = _mm_add_ps(dst128[3], _mm_mul_ps(b, _mm_set1_ps(R32[13])));\
// 	\
// 	dst128[0] = _mm_add_ps(dst128[0], _mm_mul_ps(c, _mm_set1_ps(R32[2])));\
// 	dst128[1] = _mm_add_ps(dst128[1], _mm_mul_ps(c, _mm_set1_ps(R32[6])));\
// 	dst128[2] = _mm_add_ps(dst128[2], _mm_mul_ps(c, _mm_set1_ps(R32[10])));\
// 	dst128[3] = _mm_add_ps(dst128[3], _mm_mul_ps(c, _mm_set1_ps(R32[14])));\
// 	\
// 	dst128[0] = _mm_add_ps(dst128[0], _mm_mul_ps(d, _mm_set1_ps(R32[3])));\
// 	dst128[1] = _mm_add_ps(dst128[1], _mm_mul_ps(d, _mm_set1_ps(R32[7])));\
// 	dst128[2] = _mm_add_ps(dst128[2], _mm_mul_ps(d, _mm_set1_ps(R32[11])));\
// 	dst128[3] = _mm_add_ps(dst128[3], _mm_mul_ps(d, _mm_set1_ps(R32[15])));
...
namespace XGK::MATH {
	...
	void Mat4::mul (void* left, void* right)
	{
		__m128* _this = (__m128*) this;
		__m128* _left = (__m128*) left;
		__m128* _right = (__m128*) right;

		MUL(_this, _left, _right)
	}
}
...
namespace XGK::MATH::MAT4 {
	...
	void mul128 (void* dst, void* left, void* right)
	{
		__m128* _dst = (__m128*) dst;
		__m128* _left = (__m128*) left;
		__m128* _right = (__m128*) right;
	...
	void premul128 (void* dst_matrix_addr, void* src_matrix_addr) {
		...
		alignas(16) __m128 dst_matrix_addr_float[4];
		__m128* src_matrix_addr_float = (__m128*) src_matrix_addr;
	...
	void postmul128 (void* dst_matrix_addr, void* src_matrix_addr) {
		...
		__m128* dst_matrix_addr_m128 = (__m128*) dst_matrix_addr;
		__m128* dst_matrix_addr_float = (__m128*) dst_matrix_addr;
		__m128* src_matrix_addr_128 = (__m128*) src_matrix_addr;

		MUL(dst_matrix_addr_m128, dst_matrix_addr_float, src_matrix_addr_128)
	}
	...
	// 	alignas(16) __m128 dst_matrix_addr_float[4];
	// 	alignas(16) float src_matrix_addr_float[16];
	// 	__m128* vector_addr_float = (__m128*) vector_addr;
	...
	// 	__m128* dst_matrix_addr_m128 = (__m128*) dst_matrix_addr;
	// 	float* dst_matrix_addr_float = (float*) dst_matrix_addr;
	// 	alignas(16) __m128 src_matrix_addr_float[4];
	// 	__m128* vector_addr_float = (__m128*) vector_addr;
